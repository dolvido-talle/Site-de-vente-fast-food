...
<html>
    ...
    <?php //on vérifie si l'utilisateur est connecté avant de passer sur cette page sinon on le rédirige à l'accueil
    session_start();
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="#"><i class="fa fa-home" aria-hidden="true"></i>Burger_Code <span
