...
<body>
    ...
    <div class="container site">
        ...
        <marquee style="color:white">CETTE PAGE EST CONFIDENTIELLE</marquee>
        <marquee style="color:white" direction="right">Welcome Mr/Mme

            <?php 
              require 'admin/database.php';
            //on vérifie si l'utilisateur est connecté avant de passer sur cette page sinon on le rédirige à l'accueil
            session_start();
            ...
            if (isset($_SESSION["autoriser"]) && $_SESSION["autoriser"] === "oui") {
                ...
                // Récupérer le nombre de points de l'utilisateur depuis la base de données
                $db = Database::connect();
    $requete = $db->prepare("SELECT points FROM users WHERE email = :email");
    $requete->execute(array("email" => $email));
    $resultat = $requete->fetch(PDO::FETCH_ASSOC);

    // Afficher le nombre de points de l'utilisateur
    echo'<br>';
    echo "nombre de points de l'utilisateur est : " . $resultat['points'];
            }
       ...
       echo' </marquee>
        ...
        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> FAST-FOOD <span class="glyphicon glyphicon-cutlery"></span>

        
            <ul class="nav navbar-nav navbar-right">

                <li class="nav-item" style="font-size: medium;padding: 11%;margin: right 20px;">
